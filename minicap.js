...
module.exports = syrup.serial()
  ...
  .define(function(options, adb, properties, abi) {
    ...
    , xml: {
      ...
      , dest: '/data/local/tmp/policy.xml'
      , mode: 0755
      }
    , font: {
        src: pathutil.requiredMatch(abi.all.map(function(supportedAbi) {
      ...
      , dest: '/data/local/tmp/DroidSansFallback.ttc'
      , mode: 0755
      }
    , lib: {
    ...
    function installAll() {
      ...
      , removeResource(resources.xml).then(installResource)
      , removeResource(resources.font).then(installResource)
